...
class ManageUserController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $layout_template = !empty($business->common_settings['layout_template']) ? $business->common_settings['layout_template'] : 'default';
            ...
            return Datatables::of($users)
                ->editColumn('username', function ($row) use ($layout_template) {
                    $html = $row->username;
                    if (empty($row->allow_login)) {
                        $class = $layout_template == 'viho' ? 'badge badge-light-danger' : 'label bg-gray';
                ...
                ->addColumn(
                    'action',
                    function ($row) use ($layout_template, $is_ai_template) {
