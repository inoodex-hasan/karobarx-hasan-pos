...
class InvoiceLayoutController extends Controller
{
    ...
    {
        return 'templates.viho.invoice_layout.' . $view;
    }
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'invoice_layout.create')->with(compact('designs', 'is_warranty_enabled', 'has_number_formatter'));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'invoice_layout.edit')
