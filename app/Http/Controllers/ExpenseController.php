...
class ExpenseController extends Controller
{
    ...
    {
        return 'templates.viho.expense.' . $view;
    }
    ...
    {
        return $this->isAiTemplateRequest() ? '/ai-template/expenses' : '/expenses';
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect($this->isAiTemplateRequest() ? 'ai-template/expenses' : 'expenses')->with('status', $output);
    }
