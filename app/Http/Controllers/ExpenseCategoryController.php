...
class ExpenseCategoryController extends Controller
{
    ...
    {
        return 'templates.viho.expense_category.' . $view;
    }
    ...
    public function create()
    {
        ...
        if (request()->ajax()) {
            return view('templates.viho.expense_category.create')->with(compact('categories'));
        }
    ...
    public function edit($id)
    {
        ...
        // For AJAX requests (modal), return modal view
        if (request()->ajax()) {
            return view('templates.viho.expense_category.edit')
