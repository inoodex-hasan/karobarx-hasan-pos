...
<aside
    ...
    @php($theme_color = session('business.theme_color') ?: 'primary')
    <a href="{{ route('home') }}"
        class="tw-flex tw-items-center tw-justify-center tw-w-full tw-border-r tw-h-15 tw-bg-{{ $theme_color }}-800 tw-shrink-0 tw-border-primary-500/30">
