    ...
    ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;']
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('common_settings[layout_template]', $layout_templates, !empty($common_settings['layout_template']) ? $common_settings['layout_template'] : 'default', ['class' => 'form-control select2', 'style' => 'width: 100%;', 'id' => 'layout_template']) !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
