...
@section('title', __('lang_v1.add_sales_commission_agent'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h5 class="mb-0">@lang('lang_v1.add_sales_commission_agent')</h5>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="card-body">
                    {!! Form::open([
                        'url' => route('ai-template.sales-commission-agents.store'),
                        'method' => 'post',
                        ...
                        success: function(result) {
                            if (result.success == true) {
                                ...
                                window.location.href =
                                    "{{ route('ai-template.sales-commission-agents.index') }}";
                            } else {
