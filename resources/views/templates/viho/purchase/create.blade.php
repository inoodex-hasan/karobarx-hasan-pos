...
<section class="content-header">
    <div class="tw-flex tw-justify-between tw-items-center">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black use_ai_btn">@lang('purchase.add_purchase') <i class="fa fa-keyboard hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('templates.viho.purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
    </div>
</section>
...
<section class="content">
	...
	{!! Form::open(['url' => route($route_prefix . 'purchases.store'), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
