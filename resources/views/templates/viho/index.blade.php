...
<head>
    ...
    <style>
        /* Viho demo loader relies on Viho JS; hide it since we run app JS instead. */
        .loader-wrapper {
            display: none !important;
        }

        /* Default header uses white text for dark gradient; Viho header is white. Force readable colors here. */
        .default-header-embedded .tw-text-white,
        .default-header-embedded .hover\:tw-text-white:hover {
        ...
        .default-header-embedded [class*="tw-bg-"][class*="-800"],
        .default-header-embedded [class*="tw-bg-"][class*="-700"] {
        ...
        .default-header-embedded .tw-shadow-lg,
        .default-header-embedded .tw-shadow-md,
        .default-header-embedded .tw-shadow {
            box-shadow: 0 10px 30px rgba(19, 23, 34, 0.12) !important;
        }

        /* Don't duplicate left sidebar buttons inside embedded header */
        ...
        /* Remove "card/button" feel and vertically center */
        .default-header-embedded summary,
        .default-header-embedded a,
        .default-header-embedded button,
        .default-header-embedded .btn {
            box-shadow: none !important;
        }

        .default-header-embedded .tw-ring-1 {
                    ...
                    {{-- <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown"><i data-feather="message-square"></i>
                            <ul class="chat-dropdown onhover-show-div">
                                ...
                                <li class="text-center"> <a class="f-w-700" href="../template/chat.html">See All </a>
                                </li>
                            </ul>
                        </li>
                        <li class="onhover-dropdown p-0">
                            <button class="btn btn-primary-light" type="button"><a href="../template/login_two.html"><i
                                            ...
                                            <div class="header-top">
                                                <div class="setting-list bg-primary position-unset">
                                                    <ul class="list-unstyled setting-option">
                                                        ...
                                                        <li><i class="icofont icofont-error close-card font-white">
                                                            </i></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card trasaction-sec">
                                        <div class="card-header">
                                            <div class="header-top d-sm-flex align-items-center">
                                                <h5>Transaction</h5>
                                                <div class="center-content">
                                                    <p id="viho_success_txn_text">5878 Suceessfull Transaction</p>
                                                </div>
                                                <div class="setting-list">
                                                    <ul class="list-unstyled setting-option">
                                                        <li>
...
&lt;/div&gt;</code></pre>
    ...
    {{-- Viho demo JS bundle disabled; use app JS so default header widgets behave the same. --}}
    {{-- -
    <!-- latest jquery-->
    {{--
